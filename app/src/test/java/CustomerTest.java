...
public class CustomerTest {
	...
	private Rental getInterstellarRentalFor(int daysRented) {
		return new Rental(new Movie("Interstellar", Movie.NEW_RELEASE),
				daysRented);
	}

	private Rental getJudgeRentalFor(int daysRented) {
		return new Rental(new Movie("The Judge", Movie.NEW_RELEASE),
				daysRented);
	}
	...
	private Rental getGodFatherRentalFor(int daysRented) {
		return new Rental(new Movie("The Godfather", Movie.REGULAR),
				daysRented);
	}
